<template>
  <div style="position: relative">
    <div style="position: fixed;margin: 0 160px;z-index: 8">
      <el-button size="mini" type="primary" @click="option.refresh = !option.refresh">手动刷新</el-button>
    </div>
    <el-form label-width="100px" size="mini">
      <el-form-item label="表头背景色">
        <el-color-picker v-model="option.headerBGC" show-alpha/>
      </el-form-item>
      <el-form-item label="奇数行背景色">
        <el-color-picker v-model="option.oddRowBGC" show-alpha/>
      </el-form-item>
      <el-form-item label="偶数行背景色">
        <el-color-picker v-model="option.evenRowBGC" show-alpha/>
      </el-form-item>
      ...
      <el-form-item label="行号表头">
        <el-input v-model="option.indexHeader"/>
      </el-form-item>
      <el-form-item label="滚动方式">
        <el-select v-model="option.carousel" placeholder="请选择">
